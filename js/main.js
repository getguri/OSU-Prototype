...
$(document).ready(function(){
    ...
    $(document).on('click', "#addAccordion", function() {
        ...
        var newDiv = '<div class="accordion-heading">    <i class="fa fa-plus-square-o f-s-20"><span class="accordion-toggle ng-binding" data-toggle="collapse" data-parent="#accordion" href="#accordioncollapse3">TUTOR: <span style="color:#01a4e7">Dr. Richard Dawkins </span> </span></i><span class="edit fr p-t-30 p-r-35"></span>  </div>';
        var content = '<div class="accordion-body collapse" id="accordioncollapse3"><div id="tutorrating" class="accordion-inner" ng-transclude=""><div class="f-s-20 p-b-10"><span><b>Tutor Name </b> Dr. Richard Dawkins</span><span class="p-l-30"><b>Type of course </b> Full Course</span></div><div class="f-s-20 p-b-10"><span><b>Subjects </b> <span>Physics,Chemistry,Maths</span></span><span style="padding-left:17px"><b>Number of students </b><span> 1-3</span></span></div><div class="f-s-20 p-b-10"><span><b>Fees Structure </b> <span>Weekly</span></span><span class="p-l-120"><b>Fees Amount </b> <span style="padding-left:30px">Rs 2000</span></span></div>';
